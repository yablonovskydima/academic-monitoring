...
class StudentFeaturesRepository:
    ...
    def get_grade_stats(self) -> list[dict]:
        query = (
            select(
                Grade.student_id,
    ...
    def get_grade_trend(self) -> list[dict]:
        query = (
            select(
                Grade.student_id,
    ...
    def get_late_submissions(self) -> list[dict]:
        query = (
            select(
                Grade.student_id,
    ...
    def get_attendance_by_session_type(self, session_type: SessionType) -> list[dict]:
        query = (
            select(
                Attendance.student_id,
    ...
    def get_expected_gradable_sessions(self) -> list[dict]:
        query = (
            select(
    ...
    def get_graded_sessions_count(self) -> list[dict]:
        query = (
            select(
                Grade.student_id,
